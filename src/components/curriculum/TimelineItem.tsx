...
function TimelineItemHeader({
	...
	startDate,
	endDate,
}: Pick<TimelineItemProps, "title" | "company" | "startDate" | "endDate">) {
	return (
...
function TimelineItemBody({
	location,
	description,
}: Pick<TimelineItemProps, "location" | "description">) {
	return (
		<>
			<p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">📍 {location}</p>
